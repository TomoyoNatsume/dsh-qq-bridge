...
export async function installQqBridgePreset(dshHome) {
    ...
    await writeFile(compositionPath, composition.replaceAll(SKILLS_DIR_TOKEN, yamlQuote(join(targetDir, 'skills'))), 'utf8');
